...
NSString *const NOTIFICATION_CREDIT_UPDATE = @"NOTIFY_CREDIT_UPDATE";
NSString *const NOTIFICATION_CREDIT_CHANGED = @"NOTIFY_CREDIT_CHANGED";
NSString *const NOTIFICATION_MATCHES_UPDATE = @"NOTIFY_MATCHES_UPDATE";
...
NSString *const METHOD_CHECKVERIFICATION=@"checkVerifyUser";
NSString *const METHOD_VERIFYUSER=@"verifyUser";
NSString *const METHOD_VERIFYRESENDSMSCODE=@"verifyResendSMSCode";
NSString *const METHOD_VERIFYSMSCODE=@"verifySMSCode";
NSString *const METHOD_PURCHASEDVERIFY=@"purchasedVerify";
NSString *const METHOD_UPLOADVERIFYVIDEO=@"upload_verify_video";
...
NSString *const METHOD_UNMATCH_USER=@"unmatchUser";

NSString *const METHOD_SETLIKES=@"setLikes";
NSString *const METHOD_INVITEACTION=@"inviteAction";
NSString *const METHOD_GETNOTIFICATIONS=@"get_requests";
...
NSString *const METHOD_GET_TOKEN_PLANS=@"getPlans";
NSString *const METHOD_PLACE_ORDER=@"place_order";
NSString *const METHOD_GET_CREDITS=@"get_credit";
NSString *const METHOD_GET_ADMIN_SETTINGS=@"settings";
NSString *const METHOD_SEND_SPARK=@"send_spark";
NSString *const METHOD_COMPLETE_TRANSFER=@"complete_transfer";
NSString *const METHOD_WITHDRAW_CREDITS=@"withdraw_credit";
...
NSString *const PARAM_ENT_VERIFY_VIDEO=@"ent_verifyvideo";
NSString *const PARAM_ENT_USER_FBID_MINE=@"ent_user_fbid_mine";
...
NSString *const PARAM_ENT_PHONE_NUMBER = @"ent_phone_number";
NSString *const PARAM_ENT_SMS_CODE = @"ent_sms_code";
...
NSString *const PARAM_ENT_PLAN_ID = @"plan_id";
NSString *const PARAM_ENT_SENDER_USER_ID=@"sender_ent_user_fbid";
NSString *const PARAM_ENT_RECEIVER_USER_ID=@"receiver_ent_user_fbid";
NSString *const PARAM_ENT_TRANSFER_ID=@"transfer_id";
NSString *const PARAM_ENT_WITHDRAW_CREDITS=@"withdraw_credit";
NSString *const PARAM_ENT_USER_EMAIL=@"email";


NSString *const PARAM_ENT_UNMATCH_USER_ID=@"ent_unmatch_user_fbid";

...
//#define API_URL    @"http://srsahu.com/surefire/process.php/"
//
//#define API_URL_Pay    @"http://srsahu.com/surefire/pay.php/"

#define API_URL    @"http://surefirematch.com/app/surefire/process.php/"

#define API_URL_Pay    @"http://surefirematch.com/app/surefire/pay.php/"


//#define API_URL    @"http://192.168.1.5/Flamer/process.php/"  //Development

//#define API_URL    @"http://elluminati.in/Flamer_nofacebook_developer/process.php/"//Development
//#define API_URL    @"http://elluminati.in/Flamer_nofacebook/process.php/"//Live
//#define API_URL      @"http://192.168.0.114/flamer_clone/Flamer_nofacebook/process.php/"//Local

/* Development URL
 http://elluminati.in/Flamer_nofacebook_developer/
 http://elluminati.in/Flamer_nofacebook_developer/admin
 */
...
#define TEMPLTE2_RED_COLOR  [UIColor colorWithRed:255.0/255.0 green:0.0/255.0 blue:0.0/255.0 alpha:1.0]
...
#define Show_AlertView_NO_YES(title , msg ,del) [[[UIAlertView alloc] initWithTitle:title message:msg delegate:del cancelButtonTitle:@"NO" otherButtonTitles:@"YES", nil] show]


//Notification Observers
extern NSString *const NOTIFICATION_CREDIT_UPDATE;
extern NSString *const NOTIFICATION_CREDIT_CHANGED;
extern NSString *const NOTIFICATION_MATCHES_UPDATE;
...
extern NSString *const METHOD_GET_TOKEN_PLANS;//get token plans
extern NSString *const METHOD_PLACE_ORDER;
extern NSString *const METHOD_GET_CREDITS;
extern NSString *const METHOD_GET_ADMIN_SETTINGS;
extern NSString *const METHOD_SEND_SPARK;
extern NSString *const METHOD_COMPLETE_TRANSFER;
extern NSString *const METHOD_WITHDRAW_CREDITS;
extern NSString *const METHOD_UNMATCH_USER;
extern NSString *const METHOD_CHECKVERIFICATION;
extern NSString *const METHOD_VERIFYUSER;
extern NSString *const METHOD_VERIFYRESENDSMSCODE;
extern NSString *const METHOD_VERIFYSMSCODE;
extern NSString *const METHOD_PURCHASEDVERIFY;
extern NSString *const METHOD_UPLOADVERIFYVIDEO;
//PARAMS
...
extern NSString *const PARAM_ENT_PHONE_NUMBER;//ent_phone_number
extern NSString *const PARAM_ENT_SMS_CODE;//ent_sms_code
...
extern NSString *const PARAM_ENT_VERIFY_VIDEO;
...
extern NSString *const PARAM_ENT_PLAN_ID; //plan_id
extern NSString *const PARAM_ENT_SENDER_USER_ID;
extern NSString *const PARAM_ENT_RECEIVER_USER_ID;
extern NSString *const PARAM_ENT_TRANSFER_ID;
extern NSString *const PARAM_ENT_WITHDRAW_CREDITS;
extern NSString *const PARAM_ENT_USER_EMAIL;


extern NSString *const PARAM_ENT_UNMATCH_USER_ID;

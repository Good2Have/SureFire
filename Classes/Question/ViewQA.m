...
-(void)setUpView
{
    ...
    self.lblOpt1=[[UILabel alloc]initWithFrame:CGRectMake(15, 186, 45, 45)];
     self.lblOpt1.numberOfLines=0;
    self.lblOpt1.text=@"A.";
    [self addSubview:self.lblOpt1];
    self.lblOpt2=[[UILabel alloc]initWithFrame:CGRectMake(15, 230, 45, 45)];
    self.lblOpt2.text=@"B.";
    [self addSubview:self.lblOpt2];
    self.lblOpt3=[[UILabel alloc]initWithFrame:CGRectMake(15, 274, 45, 45)];
    self.lblOpt3.text=@"C.";
    [self addSubview:self.lblOpt3];
    self.lblOpt4=[[UILabel alloc]initWithFrame:CGRectMake(15, 318, 45, 45)];
    self.lblOpt4.text=@"D.";
    [self addSubview:self.lblOpt4];
    
    
    self.lblAns1=[[UILabel alloc]initWithFrame:CGRectMake(40, 186, 200, 45)];
    self.lblAns1.numberOfLines=0;
    self.lblAns1.backgroundColor=[UIColor clearColor];
    [self addSubview:self.lblAns1];
    self.lblAns2=[[UILabel alloc]initWithFrame:CGRectMake(40, 230, 200, 45)];
    self.lblAns2.numberOfLines=0;
    self.lblAns2.backgroundColor=[UIColor clearColor];
    [self addSubview:self.lblAns2];
    self.lblAns3=[[UILabel alloc]initWithFrame:CGRectMake(40, 274, 200, 45)];
    self.lblAns3.numberOfLines=0;
    self.lblAns3.backgroundColor=[UIColor clearColor];
    [self addSubview:self.lblAns3];
    self.lblAns4=[[UILabel alloc]initWithFrame:CGRectMake(40, 318, 200, 45)];
...
-(void)setAllViews:(NSDictionary *)dictData Submit:(BOOL)submit
{
    if (submit) {
...
-(void) saveSelectedAnswer
{
    ...
    NSMutableArray *arrayAnswers = [defaults rm_customObjectForKey:@"arrayAnswers"];
    if (arrayAnswers == nil) {
        arrayAnswers = [[NSMutableArray alloc] init];
    }

    [arrayAnswers removeObject:dictAns];
    [arrayAnswers addObject:dictAns];
    [defaults rm_setCustomObject:arrayAnswers forKey:@"arrayAnswers"];

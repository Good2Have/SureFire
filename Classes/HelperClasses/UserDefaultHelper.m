...
NSString *const UD_AVAILABLE_CREDITS=@"availableCredits";
NSString *const UD_PAYPAL_EMAIL=@"paypal_email";
...
-(NSArray *)getAvailableCredits
{
    availableCredits=[USERDEFAULT objectForKey:UD_AVAILABLE_CREDITS];
    return availableCredits;
}

-(NSString *)getEmailForPaypal
{
    return [USERDEFAULT objectForKey:UD_PAYPAL_EMAIL];
}
...
-(void)setAvailableCredits:(NSArray *)arrayCredits
{
    availableCredits  = arrayCredits;
    [USERDEFAULT setObject:availableCredits forKey:UD_AVAILABLE_CREDITS];
    [USERDEFAULT synchronize];
}

-(void)setEmailForPaypal:(NSString *)emailPaypal
{
    [USERDEFAULT setObject:emailPaypal forKey:UD_PAYPAL_EMAIL];
    [USERDEFAULT synchronize];
}

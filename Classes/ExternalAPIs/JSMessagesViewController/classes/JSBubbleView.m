...
- (void)setText:(NSString *)text
{
    ...
    if ([self isText:text]) {
        ...
        UIImage *img=[UIImage imageNamed:@"imgPlaceholder"];
        [self.textImageView downloadFromURL:text withPlaceholder:img];
    }
    [self setNeedsLayout];
}
...
- (void)layoutSubviews
{
    ...
    CGRect textFrame = CGRectMake(textX,
                                  self.bubbleImageView.frame.origin.y + 10,
